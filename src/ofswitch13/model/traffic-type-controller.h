...
#ifndef TRAFFIC_TYPE_CONTROLLER_H
#define TRAFFIC_TYPE_CONTROLLER_H
 ...
 */
class TrafficTypeController : public OFSwitch13Controller
{
public:
  TrafficTypeController ();          //!< Default constructor.
  virtual ~TrafficTypeController (); //!< Dummy destructor.
...
private:
  /**
   * Configure the car switch.
   * \param swtch The switch information.
   */
  void ConfigureCarSwitch (Ptr<const RemoteSwitch> swtch);
  ...
  ofl_err SwitchInterface (Ptr<const RemoteSwitch> swtch,
    uint32_t xid, uint16_t altRouteNumber);
...
#endif /* TRAFFIC_TYPE_CONTROLLER_H */

...
main (int argc, char *argv[])
{
  ...
  // enb
  ltePositionAlloc->Add (Vector(  0, 50, 0));
  ...
  uemmWaveDevs.Add ( (mmWaveHelper->InstallUeDevice (ueServerNodeC)).Get (0));
  ...
  ueIpIface5g = epcHelper5g->AssignUeIpv4Address (uemmWaveDevs);

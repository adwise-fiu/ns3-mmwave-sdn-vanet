...
main (int argc, char *argv[])
{
  ...
  if (verbose)
    {
      ...
      // LogComponentEnable ("OFSwitch13Port", LOG_LEVEL_DEBUG);
  ...
  // sinkApps.Add (dlsinkHelper.Install (mmWaveNodeContainer.Get (0)));
  ...
  // srcApps.Add (srcHost.Install(mmWaveNodeContainer.Get (0)));
